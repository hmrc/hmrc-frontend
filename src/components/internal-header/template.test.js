...
describe('Internal Header', () => {
  ...
  describe('with Tudor Crown logo specified', () => {
    it('should have St Edwards Crown logo when specified', () => {
      const $ = render('internal-header', examples['with-tudor-crown']);

      expect($('.hmrc-internal-header__logo-link > svg').html().trim()).toContain('<path class="cls-1" d="m28.5,16.6c.82-.34,1.22-1.29.88-2.12-.34-.83-1.3-1.24-2.12-.9-.84.34-1.23,1.31-.89,2.14.34.83,1.3,1.23,2.14.88Z"></path>');
    });
  });
