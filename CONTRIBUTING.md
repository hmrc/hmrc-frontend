...
* If you run into a problem where all of the visual regression tests are failing for files not being found, ensure you have installed `wget` on your system. For mac: `brew install wget`.
